  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <h1 className="text-2xl font-bold">{organization.name} – Equipo</h1>
        <TenantNav />
      </div>
      <p className="text-muted-foreground mb-6">
        Invita empleados por correo. Ellos recibirán un enlace para unirse.
      </p>
      ...
      <Card className="max-w-md">
        <CardHeader>
          ...
          <CardDescription>
            El empleado recibirá un correo con el enlace. También puedes copiar el
            enlace y enviarlo manualmente.
          </CardDescription>
        </CardHeader>
