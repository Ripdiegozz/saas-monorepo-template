...
export default function OnboardingPage() {
    ...
    return (
      <div className="flex min-h-svh items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardHeader>
            <CardTitle>Elige tu negocio</CardTitle>
            <CardDescription>
              Tienes acceso a estas organizaciones. Selecciona una para continuar.
            </CardDescription>
          </CardHeader>
  ...
  return (
    <div className="flex min-h-svh items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle>Crea tu primer negocio</CardTitle>
          <CardDescription>
            Como usuario nuevo, necesitas crear una organización para empezar a recibir reservas.
          </CardDescription>
        </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-xs">
                Tus clientes reservarán en /b/{slug || "mi-peluqueria"}
              </p>
            </div>
          </CardContent>
